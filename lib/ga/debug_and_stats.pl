...
unit(debug_and_stats).

open_pred(debug_and_stats, write_pnode(f_node)).
open_pred(debug_and_stats, write_node(f_node)).
open_pred(debug_and_stats, write_fringe(fringe, callable)).
